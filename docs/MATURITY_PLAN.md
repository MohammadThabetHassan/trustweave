...
| Distribution | `0.2.1` is published on PyPI, validated through TestPyPI, and recorded as GitHub Release `v0.2.1`. Source is prepared for the unreleased developer-experience patch candidate `0.2.2`. Annotated `v0.2.0` remains immutable unpublished audit evidence at `7232fe3a23d92f50a693903c0a6b7cb92d0a1426`; it was never published and has no GitHub Release. | Publication, tagging, signing, and release creation remain owner-controlled. |
