...
| `LocalReviewResult` | Immutable typed envelope for an already-generated local review artifact; validates only its common schema, findings, summary, and limits fields. |
