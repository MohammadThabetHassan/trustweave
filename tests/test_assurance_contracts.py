...
def test_assurance_contract_rejects_published_v1alpha3_boundary_drift(
    ...
    """Published 0.2.3 cannot be relabelled as the unreleased v1alpha3 artifact writer."""
    ...
    assert "Compatibility published 0.2.3 bundle_diff writer must be v1alpha2" in (
