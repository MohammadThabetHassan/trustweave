...
| Package release path | Complete | [`trustweave==0.2.1`](https://pypi.org/project/trustweave/0.2.1/) is published through the protected OIDC path, validated from TestPyPI and PyPI, and recorded as [GitHub Release `v0.2.1`](https://github.com/MohammadThabetHassan/trustweave/releases/tag/v0.2.1). `v0.2.0` remains an immutable unpublished audit tag that must not be reused or published from. |
