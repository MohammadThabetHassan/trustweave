...
| Bundle diff | [`bundle-diff-v1alpha3.schema.json`](../schemas/bundle-diff-v1alpha3.schema.json) | `trustweave.dev/bundle-diff/v1alpha3` | [`bundle-diff-v1alpha1.schema.json`](../schemas/bundle-diff-v1alpha1.schema.json) and [`bundle-diff-v1alpha2.schema.json`](../schemas/bundle-diff-v1alpha2.schema.json) remain readable by compatible consumers. |
