...
- [ ] I identified the corresponding maintainer decision and exact evidence required by [`docs/archive/MAINTAINER_HANDOFF.md`](../docs/archive/MAINTAINER_HANDOFF.md).
