...
| Governance and review | Protected `main` requires the project’s quality check and a non-author approval. | Governance reduces change-control risk; it does not establish external adoption or security efficacy. |
